...
read_when:
  ...
  - Setting up agent workflows, ADRs, and docs validation.
---
...
- `docs/agent-skills.md`: curated vendored Vercel, Addy Osmani, Matt Pocock, and Chrome DevTools skills plus the update policy.
